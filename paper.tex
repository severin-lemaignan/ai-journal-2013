...
We are planning to extend the scheme by taking into accoount situation where
divergent belief may appear between the human and the robot. Preliminary
results have been pusblished in~\cite{warnier2012when}.

There is also extensive work to be done in order to refine the notion of "good
shared plan" and "good/acceptable robt behaviour" in this context. There are
