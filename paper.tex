...
reasoning on this knowledge to make decisions; and eventually instanciating
...
\fxfatal{Merge the following 3 paragraphs}
Our frame is the robot which is
...
contribution and relate them to other recent researches in the field.
...
\begin{figure}
    ...
    agents, and fed them to the knowledge base.}
...
to relations between objects, robots and humans (Figure~\ref{fig|spark-oro}),
