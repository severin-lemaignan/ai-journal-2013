...
\fxnote{Add 2-3 lines to summarize the AI highlights of SPARK}
...
\begin{figure*}[!t]
	\centering
    \subfigure[] { \includegraphics[width=0.2\textwidth]{figs/reachex-1.jpg} }
    \subfigure[] {\includegraphics[width=0.2\textwidth]{figs/reachex-2.jpg} }
    \subfigure[] {\includegraphics[width=0.2\textwidth]{figs/reachex-3.jpg} }
    \subfigure[] {\includegraphics[width=0.2\textwidth]{figs/reachex-4.jpg} }
...
directly perceived or inferred from its initial perceived trajectory\fxwarning{we really do that?}.
...
actions\fxwarning{Rephrase: the definition is actually generic to HTN, not HATP
specfic}. The \emph{planning domain} defines the set of methods describing how
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.9\linewidth]{./figs/pt.jpg}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.9\linewidth]{./figs/inTheBox2.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\columnwidth]{./figs/cleantable.jpg}
