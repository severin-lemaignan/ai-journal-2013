...
\authorrunning{R. Alami, M. Warnier, J. Guitton, S. Lemaignan and E.A. Sisbot}
% Use \authorrunning{Short Title} for an abbreviated version of
% your contribution title if the original one is too long
\institute{ LAAS-CNRS\\ 
        Universit\'e de Toulouse, UPS, INSA, INP, ISAE, LAAS\\ 
         F-31077 Toulouse, France\\ \email{Firstname.Name@laas.fr}}
%
...
\abstract*{This paper addresses some key decisional issues that are
...
\begin{figure*}[thpb]
  \centering
  \includegraphics[width=1.0\textwidth]{./figs/archi.pdf} \\
