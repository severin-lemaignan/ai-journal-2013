...
\begin{tikzpicture}[
        ...
        \node[right=4 of kb] (plan) {\bf Plans};
        ...
        \node at (pr1 -| arobot) (ep1) {\it evaluate preconditions};
        ...
        \node[below=0.1 of me1] (ae1) {\it assess effects};

        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        \node at (pr2 -| arobot) (ep2) {\it evaluate preconditions};
        ...
        \node[below=0.1 of me2] (ae2) {\it assess effects};
